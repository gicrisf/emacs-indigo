...
build/indigo-module.so: src/indigo-module.c src/indigo-stateless-utils.c src/indigo-stateless-ops.c src/indigo-stateless-wrappers.c src/indigo-system-ops.c src/indigo-system-wrappers.c src/indigo-io-ops.c src/indigo-io-wrappers.c src/indigo-molecular-ops.c src/indigo-molecular-wrappers.c src/indigo-iterators-ops.c src/indigo-iterators-wrappers.c src/indigo-reactions-ops.c src/indigo-reactions-wrappers.c | build
	$(CC) $(CFLAGS) -o $@ $^ $(LDFLAGS)
